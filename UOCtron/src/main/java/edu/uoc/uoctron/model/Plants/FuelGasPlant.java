 ...
 * @version 1.0
 */
public class FuelGasPlant extends ThermalPlant{
    /**
     * Restart time of the plant type.
     */
    private static final Duration RESTART_TIME = Duration.of(4, ChronoUnit.HOURS);
    /**
     * Stability constant of the plant type.
     */
    private static final double STABILITY = 0.6;
    /**
     * Icon filename.
     */
    private static final String ICON = "fuel_gas.png";
    /**
     * Fuel type of this plant type.
     */
    private static final FuelType FUEL = FuelType.FUEL_GAS;

    /**
     * Constructor of a new {@code FuelGasPlant}. Passes the data to the parent constructor.
     ...
     */
    public FuelGasPlant(String name, double latitude, double longitude, String city, double maxCapacityMW){
