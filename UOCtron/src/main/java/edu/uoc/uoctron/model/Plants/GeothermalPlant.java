...
/**
 * This class represents a Geothermal Plant and contains its static information.
...
public class GeothermalPlant extends RenewablePlant{
     ...
     */
    private static final Duration RESTART_TIME = Duration.of(1, ChronoUnit.HOURS);
    /**
     ...
     */
    public GeothermalPlant(String name, double latitude, double longitude, String city, double maxCapacityMW,
